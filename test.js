...
//   const brand=[...new Set([products.map(p=>p.brand)]) ] 
    // console.log(brand.map(c=>({value:c, label:c, checked:false})))

  // Correct way to get unique brands
const uniqueBrands = [...new Set(products.map(p => p.category))];
console.log("Unique Brands:", uniqueBrands);

// Then format them as you intended
const formattedBrands = uniqueBrands.map(c => ({ value: c, label: c, checked: false }));
